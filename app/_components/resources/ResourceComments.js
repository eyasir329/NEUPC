/**
 * @file Resource Comments
 * @module ResourceComments
 *
 * Native comment section backed by the resource_comments table.
...
function CommentForm({
  ...
  function handleSubmit(e) {
    ...
    startTransition(async () => {
      const res = isEdit
        ? await editResourceCommentAction(fd)
...
function CommentItem({
  ...
  function handleDelete() {
    startDelTransition(async () => {
      ...
      const res = await deleteResourceCommentAction(fd);
