...
export default function ScrollToTop() {
  ...
  return (
    <button
      onClick={handleClick}
      className="border-neon-lime/30 text-neon-lime hover:border-neon-lime fixed right-6 bottom-6 z-50 flex h-11 w-11 touch-manipulation items-center justify-center rounded-full border bg-[#05060B]/80 shadow-[0_0_24px_rgba(182,243,107,0.25)] backdrop-blur-xl transition-all duration-300 hover:scale-110 hover:shadow-[0_0_40px_rgba(182,243,107,0.5)]"
