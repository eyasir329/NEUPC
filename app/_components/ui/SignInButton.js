...
import { signInAction } from '@/app/_lib/actions/actions';
    ...
    <form action={signInAction} className="w-full" onSubmit={handleSubmit}>
      <button
        ...
        className={cn(
          ...
          'font-heading text-[11px] font-bold tracking-[0.18em] text-zinc-200 uppercase',
      ...
      >
        ...
        <span
          className="via-neon-violet/8 pointer-events-none absolute inset-0 -translate-x-full bg-linear-to-r from-transparent to-transparent transition-transform duration-700 group-hover:translate-x-full"
          aria-hidden="true"
        />
        ...
        <span className="relative z-10 inline-flex items-center gap-3">
          {isPending ? (
            <>
              <span
                className="border-neon-violet inline-block h-4 w-4 animate-spin rounded-full border-2 border-r-transparent"
                aria-hidden="true"
              />
            ...
            <>
              ...
              <span
                aria-hidden="true"
                className="group-hover:text-neon-violet/60 ml-1 font-mono text-[10px] text-zinc-600 transition-colors"
              >
                →
              </span>
            </>
