  ...
  return (
    <div>
      ...
      <div className="mb-4 flex items-center gap-2.5">
        ...
        <div>
          <h2 className="text-base font-semibold text-white">Your Dashboards</h2>
          <p className="text-xs text-gray-500">Select a portal to continue</p>
        </div>
      </div>

      {/* Role cards grid — 1 col default, 2 col when enough space */}
