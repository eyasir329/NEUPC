/**
 * @file Create event form component
...
const inputCls =
  'w-full rounded-lg border border-white/10 bg-gray-900 px-3.5 py-2.5 text-[13px] text-gray-100 placeholder-gray-700 outline-none ring-0 transition-all focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/10 [color-scheme:dark]';
  ...
  return (
    <label className="group flex cursor-pointer items-center gap-4 rounded-xl border border-white/8 bg-gray-900/60 px-4 py-3.5 transition-colors hover:border-white/12 hover:bg-gray-900">
      <div className="min-w-0 flex-1">
        <p className="text-[13px] font-semibold text-gray-200 transition-colors group-hover:text-white">
          {label}
        </p>
        {description && (
...
function Section({
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-white/[0.07] bg-linear-to-b from-white/[0.03] to-transparent transition-all duration-200 hover:border-white/[0.11]">
      <div className="flex items-center gap-3.5 border-b border-white/[0.05] bg-white/[0.015] px-5 py-4">
        <div
          ...
          style={{
            boxShadow: `0 0 0 1px ${accentColor}15, inset 0 1px 0 ${accentColor}10`,
          }}
        >
          <Icon className="h-[17px] w-[17px]" style={{ color: accentColor }} />
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-[14px] font-bold tracking-tight text-gray-100">
            {title}
          </p>
          {description && (
            <p className="mt-0.5 text-[11px] leading-relaxed text-gray-500">
...
function SegmentedControl({ options, value, onChange }) {
  return (
    <div className="inline-flex gap-0.5 rounded-xl border border-white/8 bg-gray-900/80 p-1">
      {options.map((opt) => (
        <button
          key={opt.id}
          type="button"
      ...
      {options.map((opt) => (
        <button
          ...
          className={`flex items-start gap-3 rounded-xl border p-3.5 text-left transition-all duration-150 ${
            value === opt.id
              ? 'border-indigo-500/40 bg-indigo-500/[0.08] shadow-sm ring-1 ring-indigo-500/25'
        ...
        >
          ...
          <div className="min-w-0">
            <p
              className={`text-[13px] leading-tight font-bold ${value === opt.id ? 'text-indigo-200' : 'text-gray-200'}`}
            >
              {opt.label}
            </p>
            {opt.desc && (
              <p
                className={`mt-1 text-[11px] leading-snug ${value === opt.id ? 'text-indigo-400/80' : 'text-gray-500'}`}
              >
                {opt.desc}
              </p>
            )}
    ...
    <div className="fixed inset-0 z-50 flex flex-col overflow-hidden bg-gray-950">
      ...
      <div className="flex shrink-0 items-center justify-between border-b border-white/8 bg-gray-950/95 px-6 py-4 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[14px] leading-tight font-bold text-gray-100">
              {title || 'New Event'}
            </p>
      ...
      <div className="h-[2px] w-full shrink-0 bg-white/5">
        <div
          className="h-full bg-linear-to-r from-indigo-600 to-violet-600 transition-all duration-300"
          style={{
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 xl:px-8">
          <div className="grid grid-cols-1 items-start gap-6 xl:grid-cols-12">
            ...
            <div className="xl:sticky xl:top-8 xl:col-span-4">
            ...
            >
              ...
              >
                ...
                <div>
                  <Label hint="Shown on cards & listings">
                    Short Description
                  </Label>
                  <textarea
                    value={description}
              ...
              >
                <div>
                  ...
                  <div className="mt-1 flex flex-wrap gap-2">
                    {[...new Set([...CATEGORIES, ...allCategories])].map(
                      (c) => (
                        <Pill
                          key={c}
                          active={category === c}
                    ...
                    {customCategory &&
                      ![...CATEGORIES, ...allCategories].includes(
                        customCategory
                      ) && (
                        <Pill
                    ...
                    <div className="flex items-center gap-1">
                      <input
                        ...
                        placeholder="Custom…"
                        className="h-[30px] w-24 rounded-full border border-dashed border-white/20 bg-transparent px-3 text-[12px] text-gray-400 placeholder-gray-700 transition-colors outline-none focus:border-indigo-500/40 focus:text-gray-200"
                      />
                      {customCategory.trim() && (
                        <button
                          type="button"
                          onClick={() => setCategory(customCategory.trim())}
                          className="rounded-full border border-indigo-500/30 bg-indigo-500/10 px-2.5 py-0.5 text-[11px] font-semibold text-indigo-300 transition-colors hover:bg-indigo-500/20"
                        >
                          + Add
                        </button>
                      )}
              ...
              >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      <Label hint="Leave blank for unlimited">
                        Max Participants
                      </Label>
                      <input
                        type="number"
              ...
              <Section
                ...
                description="Featured status and searchable tags"
                accentColor="#fb923c"
              >
                <Toggle
                  value={isFeatured}
