    ...
    <div className="group flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/[0.03] p-4 transition-all duration-200 hover:border-white/20 hover:bg-white/[0.06]">
      ...
      <div className="flex shrink-0 items-center gap-2">
        <button
          ...
          aria-label="Approve"
          className="flex items-center gap-1 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-3 py-1.5 text-[10px] font-bold tracking-widest text-emerald-300 uppercase transition-colors hover:bg-emerald-500/20"
        >
        ...
        <button
          ...
          aria-label="Reject"
          className="flex items-center gap-1 rounded-2xl border border-rose-500/30 bg-rose-500/10 px-3 py-1.5 text-[10px] font-bold tracking-widest text-rose-300 uppercase transition-colors hover:bg-rose-500/20"
        >
          <X className="h-3 w-3" />
          Reject
        </button>
