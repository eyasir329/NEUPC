/**
 * @file Bootcamp form modal component
...
const INPUT_CLASS = (err) =>
  `w-full rounded-xl border bg-white/4 px-3 py-2.5 text-sm text-white placeholder-gray-600 transition-all outline-none focus:bg-white/6 ${
    err
      ? 'border-red-500/50 focus:border-red-500/40'
    ...
    >
      <div className="relative flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0d1117] shadow-2xl">
        ...
        <form
          ...
          className="scrollbar-themed flex-1 overflow-y-auto"
        >
          <div className="space-y-5 p-5">
            ...
            <FIELD
              label="URL Slug"
              error={errors.slug}
              hint="Auto-generated from title. Only lowercase letters, numbers, and hyphens."
            >
              <div className="flex items-center overflow-hidden rounded-xl border border-white/8 bg-white/4 transition-all focus-within:border-violet-500/40">
                <span className="shrink-0 pl-3 font-mono text-xs text-gray-500">
                  /bootcamps/
                </span>
                <input
                  type="text"
                  ...
                  className="flex-1 bg-transparent px-2 py-2.5 text-sm text-white placeholder-gray-600 outline-none"
                />
              </div>
            </FIELD>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-4">
                ...
                {/* Featured toggle */}
                <div className="flex items-center justify-between rounded-xl border border-white/8 bg-white/4 p-3">
                  ...
                  <label className="relative inline-flex cursor-pointer items-center">
                    ...
                    />
                    <div className="peer h-5 w-9 rounded-full border border-white/5 bg-white/10 peer-checked:bg-amber-500/30 after:absolute after:top-0.5 after:left-0.5 after:h-4 after:w-4 after:rounded-full after:bg-gray-400 after:transition-all peer-checked:after:translate-x-4 peer-checked:after:bg-amber-400" />
                  </label>
                </div>
              </div>
            </div>
            ...
            <FIELD
              ...
              hint="Leave empty for unlimited enrollment."
            >
              <div className="relative">
        ...
        {/* ── Footer ────────────────────────────────────────────────── */}
        <div className="flex shrink-0 items-center justify-end gap-2.5 border-t border-white/8 bg-white/[0.02] px-5 py-4">
          <button
            type="button"
            onClick={onClose}
