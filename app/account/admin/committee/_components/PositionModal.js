            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className="w-full cursor-pointer appearance-none rounded-xl border border-white/8 bg-white/3 px-3.5 py-2.5 text-sm text-white transition-all outline-none focus:border-indigo-500/50"
