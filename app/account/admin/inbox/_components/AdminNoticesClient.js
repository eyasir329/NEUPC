    ...
    <PageShell className="text-gray-300 selection:bg-sky-500/30">
      <div className="flex flex-col gap-6">
        <PageHeader
          ...
          meta={
            pinnedCount > 0 ? (
              <span className="flex items-center gap-1.5 rounded-md border border-sky-500/20 bg-sky-500/10 px-2.5 py-1 text-xs font-semibold tracking-wide text-sky-400 uppercase">
                <Pin size={11} />
                {pinnedCount} Pinned
              </span>
            ) : null
            ...
            <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2 border-b border-white/6 pb-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-44 rounded-lg border border-white/10 bg-white/5 py-1.5 pr-3 pl-8 text-xs text-white placeholder-gray-500 focus:border-sky-500/40 focus:outline-none"
                />
              </div>
            </div>
                          ...
                          <AnimatePresence>
                            {n.is_pinned && (
                              <motion.div
                                ...
                                className="absolute top-1/2 left-4 h-2 w-2 -translate-y-1/2 rounded-full bg-sky-500 shadow-[0_0_8px_rgba(14,165,233,0.6)]"
                              />
                            )}
                          </AnimatePresence>
