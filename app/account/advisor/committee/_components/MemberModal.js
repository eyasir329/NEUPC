...
import { Avatar } from '../../../_components/ui/dashboard';
      ...
      <div className="w-full max-w-md overflow-hidden rounded-2xl border border-white/8 bg-gray-900/90 shadow-2xl backdrop-blur-lg max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="sticky top-0 flex items-center justify-between border-b border-white/8 bg-gray-900/95 px-6 py-4 backdrop-blur-md z-10">
          <div>
            ...
            <p className="mt-1 text-[11px] text-violet-400 font-mono">
              {isCreate
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
            ...
            <div ref={userPickerRef} className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/3 border border-white/8 rounded-xl py-2.5 pl-10 pr-3.5 text-sm text-white placeholder-gray-600 outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 transition-all"
                />
              </div>
          ...
          {appointedUser && (
            <div className="rounded-xl border border-white/8 bg-white/3 p-3.5 flex items-center gap-3.5 relative">
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="text-[8px] font-bold text-violet-400/80 uppercase tracking-widest mt-1 block select-none">
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full bg-white/3 border border-white/8 rounded-xl py-2.5 px-3.5 text-sm text-white outline-none focus:border-violet-500/50 transition-all cursor-pointer font-sans"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5 flex items-center gap-1 select-none">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full bg-white/3 border border-white/8 rounded-xl py-2.5 px-3.5 text-sm text-white outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 transition-all font-sans"
                style={{ colorScheme: 'dark' }}
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/3 border border-white/8 rounded-xl py-2.5 px-3.5 text-sm text-white placeholder-gray-600 outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 transition-all"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-white/3 border border-white/8 rounded-xl py-2.5 px-3.5 text-sm text-white placeholder-gray-600 outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 transition-all resize-none"
            />
          </div>
          ...
          <div className="flex gap-3 border-t border-white/8 pt-5 mt-2">
            ...
            <button
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-violet-600 py-2.5 text-xs font-semibold text-white transition-all hover:bg-violet-500 hover:shadow-[0_0_20px_rgba(139,92,246,0.35)] active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
            >
