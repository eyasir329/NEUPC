/**
 * @file Blog configuration constants — executive UI (status, sort, date helpers, slug).
 * Category config is sourced from the shared library so executive and public UIs stay in sync.
 * @module executiveBlogConfig
 */

// ─── Category config (shared) ─────────────────────────────────────────────────
// Re-exported so all executive components keep a single import path.
export {
  CATEGORY_CONFIG,
