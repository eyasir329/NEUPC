  ...
  return (
    <PageShell>
      <PageHeader
        ...
        subtitle="Manage club photos and media"
        accent="cyan"
        actions={
          <button
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <StatCard icon={ImageIcon} label="Total Images" value={items.length}                            accent="blue"  />
        <StatCard icon={Tag}       label="Categories"   value={categories.length}                       accent="cyan"  />
        <StatCard icon={Star}      label="Featured"     value={items.filter((i) => i.is_featured).length} accent="amber" />
        <StatCard icon={Trash2}    label="Selected"     value={selected.size}                           accent="rose"  />
      </div>
