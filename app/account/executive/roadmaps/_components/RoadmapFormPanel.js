 ...
 *
 * @module ExecutiveRoadmapFormPanel
 */
...
function highlightCodeBlocksExecutive(htmlString) {
...
function LivePreview({
  ...
  const enhancedContent = useMemo(
    () => (isJsonContent ? '' : highlightCodeBlocksExecutive(content)),
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex items-start gap-2 rounded-lg border border-white/6 bg-white/2 px-3 py-2">
                          ...
                          <p className="text-[11px] text-gray-500">
                            ...
                            roadmaps are only visible to executives.{' '}
