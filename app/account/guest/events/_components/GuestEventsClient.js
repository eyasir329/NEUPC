...
const FALLBACK_EVENTS = [
  {
    ...
    location: 'CSE Lab-B',
    description:
      'A hands-on workshop covering modern web development techniques including React, Next.js, and Tailwind CSS. Open to all students.',
  },
  {
    id: 'fe2',
    ...
    location: 'Online',
    description:
      'Monthly competitive programming round hosted on Codeforces. Duration: 2.5 hours, 6 problems across various difficulty levels.',
  },
  {
    id: 'fe3',
    ...
    location: 'CSE Lab-A',
    description:
      'A 3-day intensive bootcamp on advanced algorithms: graph theory, segment trees, and dynamic programming optimisations.',
  },
  {
    id: 'fe4',
    ...
    location: 'Room 301',
    description:
      'Learn version control fundamentals with Git and collaboration workflows on GitHub. No prior experience required.',
  },
  {
    id: 'fe5',
    ...
    location: 'Auditorium',
    description:
      'An introductory seminar on JavaScript covering variables, functions, DOM manipulation, and async programming.',
  },
  {
    id: 'fe6',
    ...
    description:
      '24-hour hackathon focused on building solutions for local community problems. Teams of 2–4 members.',
  },
];
