/**
 * @file Shared design primitives for the member panel.
 * Mirrors the problem-solving page's visual language: dark glass cards,
 * tinted icon chips, gradient bars, motion entrance, lucide icons.
 *
 * Tokens:
