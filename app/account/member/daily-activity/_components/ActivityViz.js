    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="relative flex flex-col gap-6 overflow-hidden rounded-2xl border border-white/[0.06] bg-gray-950 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
          <div className="relative z-10 flex items-center justify-between border-b border-white/[0.06] pb-4">
            ...
            <div className="flex items-center gap-3">
              <select className="cursor-pointer rounded-md border border-white/[0.06] bg-transparent px-2 py-1 text-sm text-gray-400 transition-colors hover:bg-white/[0.01] focus:outline-none">
                <option>May 2026</option>
                <option>Jun 2026</option>
              </select>
              <Info className="h-4 w-4 cursor-pointer text-amber-500 hover:text-amber-400" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-6 gap-2 sm:gap-3">
            {Array.from({ length: 31 }).map((_, i) => (
              <div
                key={i}
                className="flex aspect-square cursor-default items-center justify-center rounded-lg bg-white/[0.01] text-sm font-medium text-gray-400 transition-colors hover:bg-indigo-500/20 hover:text-indigo-300"
              >
                {i + 1}
              </div>
            ))}
        ...
        <div className="relative flex flex-col gap-6 overflow-hidden rounded-2xl border border-white/[0.06] bg-gray-950 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
          ...
          <div className="flex w-max items-center gap-2 rounded-md border border-violet-500/20 bg-violet-500/10 px-3 py-1.5 text-xs font-semibold text-violet-400">
            <PlaySquare className="h-3.5 w-3.5" />
            Total: 0 Hours and 0 Minutes.
          </div>

          <div className="mt-6 h-[250px] w-full" style={{ minWidth: 0 }}>
            <ResponsiveContainer
              width="100%"
              height="100%"
              minHeight={250}
      ...
      {/* Activity Heatmap */}
      <div className="relative flex w-full flex-col gap-6 overflow-hidden rounded-2xl border border-white/[0.06] bg-gray-950 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
        <div className="relative z-10 flex items-center justify-between border-b border-white/[0.06] pb-4">
          <h3 className="flex items-center gap-2 text-lg font-bold text-white">
