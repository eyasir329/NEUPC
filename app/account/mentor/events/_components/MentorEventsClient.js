/**
 * @file Mentor events client component
 * @module MentorEventsClient
 */
...
const SIDEBAR_CTA = (
  <GlassCard className="border-violet-500/20 bg-linear-to-br from-gray-900 via-gray-900 to-violet-950/30">
    ...
    <p className="text-[12px] text-gray-400">
      Stay updated with upcoming workshops, contests, and mentoring sessions for
      your mentees.
    </p>
  </GlassCard>
);
  ...
  return (
    <EventListLayout
      pageHeader={{
        icon: Calendar,
        title: 'Events',
        subtitle: 'Club events and activities relevant to you and your mentees',
        accent: 'blue',
      }}
      tabs={tabs}
      events={allEvents}
