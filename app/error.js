  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#05060B] px-4 py-24 sm:px-6">
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        {/* Big label */}
        <div className="kinetic-headline font-heading mb-6 text-[clamp(4rem,18vw,10rem)] leading-none font-black text-white uppercase select-none">
          ERR
          <span
            className="text-transparent"
            style={{ WebkitTextStroke: '1.5px rgba(239,68,68,0.7)' }}
          >
            OR.
          </span>
        </div>
        ...
        {/* Terminal card */}
        <div className="relative overflow-hidden rounded-sm border border-red-500/10 bg-[rgba(12,14,22,0.75)] p-7 shadow-[0_0_60px_0_rgba(239,68,68,0.06)] backdrop-blur-2xl sm:p-8">
          ...
          <span className="bg-neon-violet/40 absolute right-0 bottom-0 h-5 w-px" />
          <span className="bg-neon-violet/40 absolute right-0 bottom-0 h-px w-5" />
          ...
          <div className="mb-4 flex items-center justify-center gap-2">
            ...
            <span className="font-mono text-[9px] font-bold tracking-[0.3em] text-red-500/70 uppercase">
              Process_Failed
            </span>
          </div>
          ...
          <div className="rounded-sm border border-red-500/10 bg-red-500/[0.03] px-4 py-3">
            <p className="font-mono text-[10px] leading-relaxed tracking-wide text-zinc-500">
              <span className="text-red-400/60">&gt;&gt;</span> {displayMessage}
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <button
              onClick={reset}
              className="group bg-neon-lime font-heading inline-flex items-center justify-center gap-2 rounded-full px-7 py-3 text-[10px] font-black tracking-[0.2em] text-black uppercase shadow-[0_0_30px_-8px_rgba(182,243,107,0.5)] transition-all hover:shadow-[0_0_45px_-5px_rgba(182,243,107,0.7)] active:scale-[0.98]"
            >
              <svg
            ...
            <Link
              href="/"
              className="group inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-7 py-3 font-mono text-[10px] tracking-[0.2em] text-zinc-400 uppercase transition-all hover:border-white/20 hover:text-zinc-200 active:scale-[0.98]"
            >
              <svg
