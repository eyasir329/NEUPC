...
const SECTIONS = [
  {
    ...
    content: (
      <p>
        By creating an account or using the Netrokona University Programming
        Club (NEUPC) website, you agree to these Terms of Service. If you do not
  ...
  },
  {
    ...
    content: (
      <ul>
        ...
        <li>
          Membership applications are subject to approval by the club executive
          committee.
        </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul>
        ...
        <li>
          Provide accurate profile information (name, session, department).
        </li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>Guest:</strong> Default role after sign-in. Can browse
            events and apply for membership.
          </li>
          <li>
            <strong>Member:</strong> Approved members with access to resources,
            discussions, contests, and event registration.
          </li>
          <li>
            <strong>Executive:</strong> Committee members with event/blog
            management capabilities.
          </li>
          <li>
            <strong>Mentor:</strong> Senior members who guide and mentor new
            members.
          </li>
          <li>
            <strong>Advisor:</strong> Faculty advisors with oversight access.
          </li>
          <li>
            <strong>Admin:</strong> System administrators with full access.
          </li>
        </ul>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>Respect:</strong> Treat all members with dignity. No
            discrimination, harassment, or bullying.
          </li>
          <li>
            <strong>Academic Integrity:</strong> Do not plagiarize code or
            solutions in contests, tasks, or discussions.
          </li>
          <li>
            <strong>Non-political:</strong> The club is strictly non-political.
            No political activities or discussions within club platforms.
          </li>
          <li>
            <strong>Professionalism:</strong> Maintain professional conduct in
            all club communications and events.
          </li>
          <li>
            <strong>Collaboration:</strong> Share knowledge, help others learn,
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          Blog posts, resources, and tutorials published on the website remain
          the intellectual property of their respective authors.
        </li>
        <li>
          By posting content, you grant NEUPC a non-exclusive license to display
          it on the website.
        </li>
        <li>
          Do not upload copyrighted material without proper attribution or
          permission.
        </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <p>
        The club reserves the right to suspend or terminate any account that
        violates these terms, the code of conduct, or university policies.
        Members may also request voluntary account deletion via the{' '}
        <Link
          href="/contact"
  ...
  },
  {
    ...
    content: (
      <p>
        The NEUPC website is provided &quot;as is&quot; without warranties of
        any kind. The club is not liable for any damages arising from the use of
        this website, including but not limited to data loss, service
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        changes will be communicated via announcements.
      </p>
    ),
  },
  {
        ...
        <div className="mb-16 sm:mb-20">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 border-t border-white/5 pt-6">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-neon-lime/60 text-[14px]">
                description
              </span>
            ...
            <Link
              href="/privacy"
              className="text-neon-violet/70 hover:text-neon-violet font-mono text-[9px] tracking-[0.25em] uppercase transition-colors"
            >
              Privacy Policy →
            </Link>
          </div>
            ...
            >
              <div className="flex gap-6 sm:gap-8">
                ...
                <div className="shrink-0 pt-0.5">
                  <span className="text-neon-lime/40 group-hover:text-neon-lime/70 font-mono text-[10px] font-bold tracking-widest transition-colors">
                    {section.id}
                  </span>
                </div>
